# [gpt6 Astra-claude全模型支持-grok4.7-deepseekv4.1-glm5.3全模型支持-gemini全模型支持破甲越狱](https://github.com/3641397194-wq/gpt6-Astra) Desktop

完整桌面工作台：启动页、指挥台、五档工作档位、五个 BREAK//OPEN 通道、六个模型席位（含 GLM 5.3全模型支持与 Gemini全模型支持）、明确目标输入、活动流、结果面板、隔离状态与社群入口。
